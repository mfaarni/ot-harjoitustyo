...
class Login():
    ...
    def __init__(self):
        ...
        self.text_error=self.error_font.render('TRY A LONGER NAME',True,(230,40,80))
        self.error_timer=0
    ...
    def run_login(self):
        while True:
            ...
            screen.blit(self.start_font.render('START', True, white), (START_BUTTON_WIDTH /
                        2-40, START_BUTTON_HEIGHT/2-10))
            screen.blit(self.start_font.render('NAME:', True, white), (START_BUTTON_WIDTH /
                        2-80, START_BUTTON_HEIGHT/2-140))
