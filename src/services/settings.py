...
LEVEL_MAP = [
    ...
    "  P  GGGXXX    XXXX    XXXXX    GGXXXXXXXXXXXXXXXXXXXXXGGGGXXXXXXXXXXX  XXXXXXXXXXXXXXXXXXXXXXXXXM M      XXXXXXXXXXXXXXXXXXXXXXXXX   XXX   XX   XXX   XX   X  X  XXX",  # pylint: disable=line-too-long
